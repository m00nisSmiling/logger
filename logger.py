...
try:
    ...
    riskLabel.grid( row=4, column=0, sticky="e")
    riskComboBox.grid( row=4, column=1, sticky="w")
    vulnUrl.grid( row=5, column=0, sticky="e")
    vulnUrlEnt.grid( row=5, column=1, sticky="w")
    methodLabel.grid( row=6, column=0, sticky="e")
    methodComboBox.grid( row=6, column=1, sticky="w")
    dataLabel.grid( row=7, column=0, sticky="e")
